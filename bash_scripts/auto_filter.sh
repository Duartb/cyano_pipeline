...
do
  ...
  echo -e "Running:\nbbduk.sh in1=./rawReads/$f1 in2=./rawReads/$f2 out1=./outputs/readsFiltered/temp/$f1 out2=./outputs/readsFiltered/temp/$f2 trimq=$1"
  bbduk.sh in1=./outputs/readsTrimmed/$f1 in2=./outputs/readsTrimmed/$f2 out1=./outputs/readsFiltered/temp/$f1 out2=./outputs/readsFiltered/temp/$f2 trimq=$1;
done
