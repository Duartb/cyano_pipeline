...
do
  ...
  # Writing run log
 echo "$(date) [BBMAP_COVERAGE] bbmap.sh in1=$1/readsFiltered/$r1 in2=$1/readsFiltered/$r2 ref=$f covstats=$1/coverages/$cov slow k=12 path=$1/coverages t=$2 : done" >> $1/commands.log

 # Running Quast
 bbmap.sh in1=$1/readsFiltered/$r1 in2=$1/readsFiltered/$r2 ref=$f outm=$1/mappedReads/$base_name covstats=$1/coverages/$cov slow k=12 path=$1/coverages t=$2 >>$1/console.log 2>> $1/console.log;
done
